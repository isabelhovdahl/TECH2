...
> 📝 **Already have Miniforge?** You don't need to reinstall it. Open Terminal, run `conda update -n base -c conda-forge conda`, then go straight to the [verification checklist](verify-installation.md).
